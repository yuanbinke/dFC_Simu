...
clock=0;
for si=1:10000
Atmp=[2 sin(si/64)*5; sin(si/64)*5,3];
...
%         'XTickLabel', {'100','200','300','400','500','600'}, ...
%         'TickLength', [0 0]);
set(gca, 'XTick', [20 103 205 307 410 512], ...
        'XTickLabel', {'0.01','0.05','0.1','0.15','0.2','0.25'}, ...
        'TickLength', [0 0]);
set(gca, 'TickDir', 'in', 'Xgrid', 'on'); 
set(gca, 'FontName','Arial','FontSize',24,'LineWidth', 2);
% title('DCC - dynamic correlation between nodes 1 and 2')
...
subplot(3, 1, 3)
plot(0:T-1, squeeze(Sigma(1,2,:)), 'LineWidth',3);
grid on
ylabel('Coefficient')
hold on
MTDwsize = 5;
...
cd(resultdir)
save demofft_periodic.mat
filename=[resultdir filesep 'periodic_fft'];
