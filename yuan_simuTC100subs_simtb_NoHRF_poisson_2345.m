...
Desdir=[Rootdesdir filesep 'dFC_nozscore_1TR_simu' filesep '3R1T_NoiseSD_NoHRF_pu01_au05_Poisson2345_NoiseSD' num2str(NoiseSD) filesep  'Simu10' filesep 'tc'];mkdir(Desdir)
...
cd(Desdir)
filename=[Desdir filesep 'SimuDensity_poisson_20304050_NoiseSD062'];
